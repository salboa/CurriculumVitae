...
\quote{
  ...
  attitude. Naturally inclined to provide help and guidance and embrace
...
\newcommand{\Genomsys}{
  ...
  \begin{minipage}{0.49\textwidth}
    ...
    \item[\custItem] Management and implementation of storage systems and
      backup strategies, including disaster recovery plans
    \end{itemize}
  \end{minipage}
  \vspace{0.4em}
...
\newcommand{\Phd}{
  ...
  physics; contribution to 9 papers in peer-reviewed journals
  (\scriptsize{links: 
