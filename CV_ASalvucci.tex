...
\quote{
  An analytical software developer and support engineer, with a background and
  a PhD in particle physics. Experienced at providing IT support, either face
  to face or remotely, with a strong problem solving attitude. Experienced at
  working in teams and independently in international enviroments. Naturally
  inclined in providing help and guidance and turning problems into
  opportunities.
  %challenges.
...
\newcommand{\Genomsys}{
  \begin{minipage}{0.49\textwidth}
    \begin{itemize}[labelwidth=\the\widest,align=right,leftmargin=!,labelsep=1pt,
        noitemsep]
    \item[\custItem] Implementation, management and administration of the
      company IT infrastructure both in terms of hardware and software systems
      (\textsc{\color{awesome}{GIT}}, \textsc{\color{awesome}{VPN}},
      \textsc{\color{awesome}{Jira}}, \textsc{\color{awesome}{Confluence}},
      \textsc{\color{awesome}{Nextcloud}})
  ...
  \begin{minipage}{0.49\textwidth}
    ...
    \item[\custItem] Contribution to the conception, design and specification of
      software tools and applications performing
    \item[\custItem] Implementation of storage systems and backup strategies
    \item[\custItem] Maintainer of Debian-based and Redhat-based packages of
  ...
  infrastructure to new offices in February 2020. Configuration of new servers
  for data storage and computing. Configuration and administration of the ticket
  managament system JIRA and the collaboration platform Confluence.
}
...
\newcommand{\CHUK}{
  \begin{minipage}{0.49\textwidth}
    ...
    \item[\custItem] Setup and management of student's desktop/laptop (Linux,
      MacOS and Windows) and related troubleshooting
    \end{itemize}
  \end{minipage}
  \hfill
  \begin{minipage}{0.49\textwidth}
