...
\cventry
{Bobst} % Organization
{Senior Software DFE Engineer} % Job title
...
{Senior Software Engineer and IT Operation Manager} % Job title
{Apr. 2022 - Jun. 2023} % Date(s)
{Morges (CH)} % Location
{\GenomsysSenior}

\cventry
{Genomsys} % Organization
{Software Engineer and IT Manager} % Job title
{Dec. 2019 - Apr. 2022} % Date(s)
